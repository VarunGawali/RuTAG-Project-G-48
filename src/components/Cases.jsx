              ...
              {cases.map(caseItem => (
                  <div key={caseItem.id} className='mx-auto relative mb-12 cursor-pointer'>
                      <img 
                          src={caseItem.image} 
                          alt={caseItem.title} 
                          className='hover:scale-95 transition-all duration-300 object-cover w-full h-64 max-w-full max-h-64 rounded-md' 
                      />
                      <div className='text-center px-4 py-8 bg-white shadow-lg rounded-md md:w-3/4 mx-auto absolute left-0 right-0 bottom-0 translate-y-2/3'>
                          ...
                          <div className='flex items-center justify-center gap-8 mt-4'>
                              <a className='font-bold text-brandPrimary hover:text-neutral-700' href="/">
                                  ...
                                  <svg
                                      ...
                                      width="25" height="25" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
